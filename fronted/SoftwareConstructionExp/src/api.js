...
export const api = {
  ...
  updateProject: (p) => req('/projects', { method:'PATCH', body: JSON.stringify(p) }),
  deleteProject: (id) => req(`/projects?id=${id}`, { method:'DELETE' }),
  archiveProject: (id, archived) => req('/projects/archive', { method:'POST', body: JSON.stringify({ id, archived }) }),
